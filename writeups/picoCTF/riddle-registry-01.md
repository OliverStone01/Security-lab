...
<img alt="exiftool output" src="/writeups/picoCTF/images/exiftool-output.png" width=200px>
...
Here was the output:
<img alt="Output of decoding base64" src="/writeups/picoCTF/images/base64-output.png" width=200px>
