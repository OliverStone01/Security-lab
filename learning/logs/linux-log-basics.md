...
This file explains how logs are used and where to find logs in Linux systems.

### How Linux records logs

Linux does not have a sinlge logging system. Instead, logs can be recorded by:
- The Lunux kernal
- System services
- Applications
...
Logging decisions are made by administrators and security engineers using system configuration files, logging servers, and application level setting. Not everything is logged as this can effect performance and will use up more memory.
