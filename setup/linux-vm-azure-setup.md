...
<img alt="Resource groups in menu" src="/setup/images/resource-group.png" width=150px>

3. Select **Create**.

4. Name your resource group and set a location.

<img alt="Set name and location for resource group" src="/setup/images/create-resource-group.png" width=300px>
...
<img alt="Select bash" src="/setup/images/select-bash.png" width=300px>

3. Select `Mount Storage account`, click apply.

<img alt="Mount storage account" src="/setup/images/mount-storage-account.png" width=400px>

4. Select `I want to create a storage account`

<img alt="Create storage account" src="/setup/images/create-storage-account.png" width=400px>
